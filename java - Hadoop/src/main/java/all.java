...
public class all extends Configured implements Tool {
    ...
    public static Path spellspath = new Path("/user/e.pitanov/data/fspell.txt");
...
//shows showpos showposinv clicks clickpos clickposinv meantime firstshows lastshows firstclicks lastclicks cpos spos sifc tbef taft
    private Job getJobConf(final String input, final String output) throws IOException {
        ...
        job.setJobName(all.class.getCanonicalName());
        job.setInputFormatClass(TextInputFormat.class);
    ...
    static public void main(final String[] args) throws Exception {
        final int ret = ToolRunner.run(new all(), args);
        System.exit(ret);
    }
}
